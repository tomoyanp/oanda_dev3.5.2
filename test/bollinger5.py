...
def decide_trade(insert_time, trade_obj):
    ...
    for instrument in instrument_list:
        ...
        if bollinger_flag:
            ...
            data_set = get_bollinger(instrument, insert_time, table_type="5m", window_size=21, sigma_valiable=5)
            ...
            if data_set["upper_sigmas"][-1] < ask and sma_day5 < ask:
                trade_obj["flag"] = True
                trade_obj["side"] = "buy"
                break
            elif data_set["lower_sigmas"][-1] > bid and sma_day5 > bid:
                trade_obj["flag"] = True
                trade_obj["side"] = "sell"
                break
            else:
