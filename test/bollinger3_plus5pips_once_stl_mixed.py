...
# 2. 5分足が21本ボリンジャーバンドシグマ3+5pipsに引っかかったらそっちについてく
# 3. sma21に引っかかったら決済
...
def decide_trade(insert_time, trade_obj):
    ...
    for instrument in instrument_list:
        ...
        if bollinger_flag:
            ...
            data_set = get_bollinger(instrument, insert_time, table_type="5m", window_size=21, sigma_valiable=3)
