...
def __get_price(con, targettime, tabletype, instrument):
    ...
    return close_ask, close_bid, high_ask, high_bid, low_ask, low_bid

def __get_dataset(con, instrument, targettime, tabletype, y_index):
    close_ask, close_bid, high_ask, high_bid, low_ask, low_bid = __get_price(con, targettime, tabletype, instrument)
    ...
    bef_close_ask, bef_close_bid, bef_high_ask, bef_high_bid, bef_low_ask, bef_low_bid = __get_price(con, bef_targettime, tabletype, instrument)
