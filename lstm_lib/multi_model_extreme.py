...
def get_original_dataset(target_time, table_type, span, direct):
    ...
    for insturment in instrument_list:
    ...
    instrument = "USD_JPY"
    sql = "insert_time from %s_%s_TABLE where %s order by insert_time %s limit %s" % (instrument, table_type, where_statement, direct, span)
...
if __name__ == "__main__":
    table_type = sys.args[1] #1m, 5m, 1h
    start_time = "2019-01-01 00:00:00"
    end_time = "2019-03-10 00:00:00"
    model_name = "multi_model"
    window_size = sys.args[2] #60, 60, 60
    output_train_index = sys.args[3] #60, 12, 1
