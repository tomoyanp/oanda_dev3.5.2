            ...
            if diff < threshold:
                ...
                if trade_flags["direction"] == "buy":
                    ...
                    if open_prices[0] > close_prices[0]:
                        ...
                        if low_prices[0] > low_prices[1] and barbwire_status["status"] and barbwire_status["direction"] == "buy" and close_prices[1] < close_prices[2] and current_ema25 < close_prices[2]:
                    ...
                    if open_prices[0] < close_prices[0]:
                        ...
                        if high_prices[0] < high_prices[1] and barbwire_status["status"] and barbwire_status["direction"] == "sell" and close_prices[1] > close_prices[2] and current_ema25 > close_prices[2]:
                            trade_flags["position"] = True

                # 包み足パターン
                elif trade_flags["direction"] == "buy" and outsidebar_status["status"] and outsidebar_status["direction"] == "buy" and current_ema25 < close_prices[2]:
                    trade_flags["position"] = True
                elif trade_flags["direction"] == "sell" and outsidebar_status["status"] and outsidebar_status["direction"] == "sell" and current_ema25 > close_prices[2]:
                    trade_flags["position"] = True
