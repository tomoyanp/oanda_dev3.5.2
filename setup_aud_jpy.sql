...
create table USD_JPY_3h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table CAD_JPY_3h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table CAD_USD_3h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table AUD_USD_3h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table GBP_USD_3h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table EUR_JPY_3h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table EUR_USD_3h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table AUD_JPY_3h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table GBP_JPY_3h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);


create table USD_JPY_8h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table CAD_JPY_8h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table CAD_USD_8h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table AUD_USD_8h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table GBP_USD_8h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table EUR_JPY_8h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table EUR_USD_8h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table AUD_JPY_8h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
create table GBP_JPY_8h_TABLE(open_ask double, open_bid double, close_ask double, close_bid double, high_ask double, high_bid double, low_ask double, low_bid double, insert_time timestamp primary key);
